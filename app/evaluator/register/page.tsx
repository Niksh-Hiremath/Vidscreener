  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/auth/signup', {
        ...
        body: JSON.stringify({ email, password, full_name: name, role: 'evaluator' }),
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-cyan-50 to-teal-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign up to evaluate videos</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <p className="text-center text-sm text-gray-600">
            ...
            <Link href="/evaluator/login" className="text-emerald-600 hover:text-emerald-700 font-medium">
              Log in
            </Link>
          </p>
        </div>
