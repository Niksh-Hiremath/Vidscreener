      ...
      <div className="p-4 border-t border-gray-200">
        ...
        {!isCollapsed && (
          <div className="mt-2 pt-2 border-t border-gray-200 flex flex-col gap-1">
            <Link href="/help" className="px-4 py-2 text-xs text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded transition-colors">
              📚 Help Center
            </Link>
            <Link href="/support" className="px-4 py-2 text-xs text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded transition-colors">
              💬 Contact Support
            </Link>
          </div>
        )}
